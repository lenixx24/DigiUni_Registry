...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Teacher t5 = new Teacher(5, "Herchanivska", "Polina", "Evaldivna",
                ...
                "Head", "Doctor of Cultural Studies", "Professor",LocalDate("01.01.2009"), 30);
        ...
        Teacher t6 = new Teacher(6, "Lukyanenko", "Iryna", "Gryhorivna",
                ...
                "Head", "Doctor of of Economic Sciences", "Professor", LocalDate("01.01.2009"), 30);
        Repository.addTeacher(t6);
        Department d3 = new Department(3,  "Department of Finance", fen, t6, "6-410");
        Repository.addDepartment(d3);

        Group CS1 = new Group("CS-1", d1);
        Repository.addGroup(CS1);
        Group SE3 = new Group("SE-3", d1);
        Repository.addGroup(SE3);
        Group LB2 = new Group("LB-2", d2);
        Repository.addGroup(LB2);
        Group EC4 = new Group("EC4", d3);
        Repository.addGroup(EC4);
        Group SC5 = new Group("SC-5", d2);
        Repository.addGroup(SC5);
        Group BW6 = new Group("BW-6", d2);
        Repository.addGroup(BW6);
        Student s1 = new Student(1, "Smith", "John", "Edward",
                LocalDate("15.05.2006"), "john.smith@ukma.edu.ua", "0501112233", "KM100101",
                1, CS1, 2025, "budget", "studying");
        ...
        Student s3 = new Student(3, "Williams", "Michael", "James",
                ...
                2, LB2, 2024, "budget", "academic leave");
