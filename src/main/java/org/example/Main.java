...
public class Main {
    public static void main(String[] args) {
        Teacher t1 = new Teacher(1, "Glybovets", "Andriy", "Mykolayovich",
                "25.10.80", "a.glybovets@ukma.edu.ua", "0444636985",
                "Dean", "Doctor of Technical Sciences", "Docent", "30.05.19", 30);
        ...
        Teacher t2 = new Teacher(2, "Mazin", "Dmitro", "Mykhaylovich",
                "01.01.80", "mazindm@ukma.edu.ua", "0444251420",
                "Dean", "Candidate of Philological Sciences", "Docent", "01.01.09", 30);
        ...
        Teacher t3 = new Teacher(3, "Glushcenko", "Svitlana", "Vasylivna",
                "01.01.80", "gluschenkosv@ukma.edu.ua", "0444256042",
                "Dean", "Candidate of Economic Sciences", "Docent", "01.01.09", 30);
        ...
        Teacher t4 = new Teacher(4, "Chornei", "Ruslan", "Konstyantynovych",
                "01.01.80", "r.chornei@ukma.edu.ua", "0681982970",
                "Head", "Candidate of Physical and Mathematical Sciences", "Docent", "01.01.09", 30);
        ...
        Teacher t5 = new Teacher(5, "Herchanivska", "Polina", "Evaldivna",
                "01.01.80", "p.herchanivska@ukma.edu.ua", "0444256098",
                "Head", "Doctor of Cultural Studies", "Professor", "01.01.09", 30);
        ...
        Teacher t6 = new Teacher(6, "Lukyanenko", "Iryna", "Gryhorivna",
                "01.01.80", "iryna.lukianenko@ukma.edu.ua", "0444256042",
                "Head", "Doctor of of Economic Sciences", "Professor", "01.01.09", 30);
